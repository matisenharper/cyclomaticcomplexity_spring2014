...
public class Parameterized_Kart extends Suite {
	/**
	 ...
	 */
	public Parameterized_Kart(Class<?> klass) throws Throwable {
	...
	@Override
	public void run(final RunNotifier notifier) {
		System.out.println("ParameterizedKart.run()");
		EachTestNotifier testNotifier= new EachTestNotifier(notifier,
				getDescription());
		try {
			Statement statement= classBlock(notifier);
		...
		//System.out.println("create and showgui");
		//SortFrame.createAndShowGUI();
		afterAllTests();
	}
